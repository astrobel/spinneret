...
f = open(fname, 'a')
f.write('KIC,McQuillan Period (d),Kepler LS Period (d),Kepler LS Period 2nd peak(d),Kepler LS Period 3rd peak (d),Kepler LS Period RMS,Kepler LS Period MAD,Kepler LS 2-term Period (d),Kepler LS 2-term Period 2nd peak (d),Kepler LS 2-term Period 3rd peak (d),Kepler LS 2-term Period RMS,Kepler LS 2-term Period MAD,Kepler ACF Period (d),Kepler ACF Period 2nd peak (d),Kepler ACF Period 3rd peak (d),Kepler ACF Period RMS,Kepler ACF Period MAD,TESS LS Period (d),TESS LS Period 2nd peak (d),TESS LS Period 3rd peak (d),TESS LS Period RMS,TESS LS Period MAD,TESS LS 2-term Period (d),TESS LS 2-term Period 3nd peak (d),TESS LS 2-term Period 3rd peak (d),TESS LS 2-term Period RMS,TESS LS 2-term Period MAD,TESS ACF Period (d),TESS ACF Period 2nd peak (d),TESS ACF Period 3rd peak (d),TESS ACF Period RMS,TESS ACF Period MAD,Filtered TESS LS Period (d),Filtered TESS LS Period 2nd peak (d),Filtered TESS LS Period 3rd peak (d),Filtered TESS LS Period RMS,Filtered TESS LS Period MAD,Filtered TESS LS 2-term Period (d),Filtered TESS LS 2-term Period 2nd peak (d),Filtered TESS LS 2-term Period 3rd peak (d),Filtered TESS LS 2-term Period RMS,Filtered TESS LS 2-term Period MAD,Filtered TESS ACF Period (d),Filtered TESS ACF Period 2nd peak (d),Filtered TESS ACF Period 3rd peak (d),Filtered TESS ACF Period RMS,Filtered TESS ACF Period MAD,Kepler Rvar,Kepler LS Rvar,Kepler LS 2-term Rvar,Kepler ACF Rvar,TESS Rvar,TESS LS Rvar,TESS LS 2-term Rvar,TESS ACF Rvar,Filtered TESS Rvar,Filtered TESS LS Rvar,Filtered TESS LS 2-term Rvar,Filtered TESS ACF Rvar,Kepler CDPP,TESS CDPP,Filtered TESS CDPP\n')#,Kepler percentage flagged,TESS percentage flagged\n')
f.close()
...
for i, k in enumerate(kic_r):
    ...
    f = open(fname, 'a')
    f.write(f'{k},{p_r[i]},{target_kep.p_ls1a},{target_kep.p_ls1b},{target_kep.p_ls1c},{target_kep.rms_ls1},{target_kep.mad_ls1},{target_kep.p_ls2a},{target_kep.p_ls2b},{target_kep.p_ls2c},{target_kep.rms_ls2},{target_kep.mad_ls2},{target_kep.p_acfa},{target_kep.p_acfb},{target_kep.p_acfc},{target_kep.rms_acf},{target_kep.mad_acf},{target_tess.p_ls1a},{target_tess.p_ls1b},{target_tess.p_ls1c},{target_tess.rms_ls1},{target_tess.mad_ls1},{target_tess.p_ls2a},{target_tess.p_ls2b},{target_tess.p_ls2c},{target_tess.rms_ls2},{target_tess.mad_ls2},{target_tess.p_acfa},{target_tess.p_acfb},{target_tess.p_acfc},{target_tess.rms_acf},{target_tess.mad_acf},{target_butter.p_ls1a},{target_butter.p_ls1b},{target_butter.p_ls1c},{target_butter.rms_ls1},{target_butter.mad_ls1},{target_butter.p_ls2a},{target_butter.p_ls2b},{target_butter.p_ls2c},{target_butter.rms_ls2},{target_butter.mad_ls2},{target_butter.p_acfa},{target_butter.p_acfb},{target_butter.p_acfc},{target_butter.rms_acf},{target_butter.mad_acf},{target_kep.rvar},{target_kep.rvar_ls1},{target_kep.rvar_ls2},{target_kep.rvar_acf},{target_tess.rvar},{target_tess.rvar_ls1},{target_tess.rvar_ls2},{target_tess.rvar_acf},{target_butter.rvar},{target_butter.rvar_ls1},{target_butter.rvar_ls2},{target_butter.rvar_acf},{cdpp_kep},{cdpp_tess},{cdpp_butter}\n')
    f.close()
